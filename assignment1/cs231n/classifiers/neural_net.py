...
class TwoLayerNet(object):
  ...
  def loss2(self, X, y=None, reg=0.0):
...
#    print 'loss=',loss
  ...
  def predict(self, X):
    ...
    """
    y_pred = None
    n_class = self.params['W2'].shape[1]
    ###########################################################################
    # TODO: Implement this function; it should be VERY simple!                #
    ###########################################################################

    h1 = np.maximum(np.dot(X,self.params['W1'])+self.params['b1'],0)
    y =  np.dot(h1,self.params['W2'])+self.params['b2']
